module Styles = {
  ...
  let overlay = css({
    ...
    "height": "100%",
    "zIndex": zIndex(#above),
    "background": colors(#primary700)->Polished.transparentize(0.4, _),
  ...
  let content = css({
    ...
    "animation": `${contentFadeIn} 150ms cubic-bezier(0.16, 1, 0.3, 1)`,
  })
  ...
  let close = css({
    ...
    "&:hover": {
      "background": colors(#primary200)->Polished.transparentize(0.2, _),
    },
  })
}
